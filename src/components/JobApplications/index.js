...
import { ApplyButton, BottomWrap, CompanyName, Date, HorizontalLine, JobDescription, JobType, JobWrapper, Salary, SalaryWrap, Title } from './JobApplicationElements'

const JobApplications = ({ selectedJobPage, toggleJobPage }) => {
  ...
  return (
    <JobWrapper selectedJobPage={selectedJobPage}>
        ...
        <BottomWrap>
            ...
            <ApplyButton onClick={() => toggleJobPage('jobDetails')}>Cancel</ApplyButton>
        </BottomWrap>
    </JobWrapper>
  )
}
